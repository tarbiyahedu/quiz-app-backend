...
async function debugNewQuizIssue() {
  try {
    // Connect to MongoDB
    await mongoose.connect(process.env.MONGO_URL);
    console.log('Connected to MongoDB');

    console.log('🔍 DEBUGGING NEW QUIZ SYSTEMATIC ISSUE');
    console.log('This will identify why new quizzes are still having problems');
    ...
    if (isVeryRecent) {
      ...
      console.log(`This might be the quiz you just created and took.`);
    }
    ...
    console.error('Error debugging quiz issue:', error);
  } finally {
...
module.exports = debugNewQuizIssue; 