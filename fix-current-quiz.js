...
async function fixCurrentQuiz() {
  try {
    // Connect to MongoDB
    await mongoose.connect(process.env.MONGO_URL);
    console.log('Connected to MongoDB');

    const quizId = '687b6681239045f7ebd6a9b6'; // CCCCCCCCC quiz
    ...
    console.log(`🔧 FIXING CURRENT QUIZ: ${quizId}`);
    ...
    console.error('Error fixing current quiz:', error);
  } finally {
